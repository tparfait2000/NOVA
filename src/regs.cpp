...
template <> mword Exc_regs::get_g_cs_dl<Vmcs>() const {
    return Vmcs::read(Vmcs::GUEST_AR_CS) >> 13 & 0x3;
}

template <> mword Exc_regs::get_g_flags<Vmcs>() const {
    return Vmcs::read(Vmcs::GUEST_RFLAGS);
}

template <> mword Exc_regs::get_g_efer<Vmcs>() const {
    return Vmcs::read(Vmcs::GUEST_EFER);
}
...
template <> mword Exc_regs::get_g_cr3<Vmcs>() const {
    return Vmcs::read(Vmcs::GUEST_CR3);
}
...
template <> void Exc_regs::set_g_cr3<Vmcs> (mword v) const {
    Vmcs::write(Vmcs::GUEST_CR3, v);
}
